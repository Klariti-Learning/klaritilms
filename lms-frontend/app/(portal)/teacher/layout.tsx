...
import type { ApiError, TeacherLayoutProps } from "@/types";
...
const TeacherLayout = ({ children }: TeacherLayoutProps) => {
  ...
  const handleRaiseTicket = () => {
    setIsModalOpen(false);
    router.push("/teacher/raise-query");
  };
                      ...
                      <div className="space-y-4">
                        ...
                        {notificationMethod && notificationTiming && (
                          <Button
                            ...
                            className="w-full bg-gradient-to-r cursor-pointer from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-xl shadow-md"
                          >
                            Save Preferences
                          </Button>
                        )}
            ...
            {sidebarItems.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative"
                  onMouseEnter={() =>
                    isDisabled && setShowComingSoonTooltip(item.name)
                  }
                  onMouseLeave={() => setShowComingSoonTooltip(null)}
                >
                  {isDisabled ? (
                    <div
