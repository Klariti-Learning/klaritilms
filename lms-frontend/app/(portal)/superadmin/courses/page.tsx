...
export default function Courses() {
  ...
  const handleCreateCourse = () => {
    router.push("/superadmin/courses/create");
  };
  ...
  const handlePreviewClick = (courseId: string) => {
    ...
    router.push(`/superadmin/courses/${courseId}/preview`);
  };
  ...
  const handleAssignCourse = (courseId: string) => {
    ...
    router.push(`/superadmin/courses/${courseId}/assign`);
  };

  const handleEditCourse = (courseId: string) => {
    router.push(`/superadmin/courses/${courseId}/edit`);
    setMenuOpen(null);
  };
